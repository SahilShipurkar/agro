...
export default function GlyphPortal({
  word = "Gallery", focusChar, interactive = true, background, front, children, scrollLength = 2.4,
  fontFamily = DEFAULT_FONT, fontWeight = 900, annotations = false,
  enterLabel = "Explore Products", className, style, onEnterClick, onProgress,
}: GlyphPortalProps) {
  ...
  const text = word.trim().normalize("NFC") || "Gallery";
